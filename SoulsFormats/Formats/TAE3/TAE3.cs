...
namespace SoulsFormats
{
    ...
    public partial class TAE3 : SoulsFile<TAE3>
    {
        ...
        public class Animation
        {
            ...
            /// <summary>
            /// Just a shallow copy constructor
            /// </summary>
            /// <param name="animToDupe"></param>
            public Animation(Animation animToDupe)
            {
                this.ID = animToDupe.ID;
                this.Events = animToDupe.Events;
                this.EventGroups = animToDupe.EventGroups;
                this.AnimFileReference = animToDupe.AnimFileReference;
                this.AnimFileUnk18 = animToDupe.AnimFileUnk18;
                this.AnimFileUnk1C = animToDupe.AnimFileUnk1C;
                this.AnimFileName = animToDupe.AnimFileName;
            }
